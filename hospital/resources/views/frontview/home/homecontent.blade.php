...
@section('title_area')
	 Digital Smart Health Care System
@endsection

@section('csslink_area')
	<!-- Bootstrap -->
...
@section('js_area')
    ...
    <!-- Slicknav -->
    <script src="{{ asset('styles') }}/js/jquery.slicknav.min.js"></script>
    <!-- Owl Carousel -->
    ...
    <!-- Boostrap Datepicker --> 
    <script src="{{ asset('styles') }}/js/bootstrap-datepicker.js"></script>
    <!-- Wow js -->
